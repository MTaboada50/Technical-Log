# 💻 Software - 2026
Registro de aprendizaje de programación, algoritmos y QA.

## 🏁 Hitos del Año
1. **Enero:** Inicio de transición profesional y **Sprint Intensivo de IA** (3 certificaciones en 1 semana).

## 📖 Contenidos por Categoría

### 📜 Certificaciones y Cursos
- [01. VS Code & GitHub Copilot](./Certificaciones/01-VSCode-Copilot/VSCode-Copilot.md)
- [02. Ingeniería de Prompts](./Certificaciones/02-Ingenieria-Prompts/Ingenieria-Prompts.md)
