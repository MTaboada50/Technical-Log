...
* **Búsqueda Binaria ($O(\log n)$):** Utiliza la técnica de *Divide y Vencerás*. Requiere que el conjunto de datos esté previamente ordenado. Reduce el tiempo de búsqueda exponencialmente.
